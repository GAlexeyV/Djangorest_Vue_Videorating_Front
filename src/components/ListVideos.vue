      ...
      <div class="col-md-5 text-center nicefont">
        <h4>Welcome to Video Rater</h4>
          <form @submit="createdNew()">
            <input class="btn-sm btn-primary mb-3 btn-center" id="createdNew" type="submit" value="Create a new video">
...
<style scoped>
@import url('https://fonts.googleapis.com/css2?family=Roboto+Condensed:wght@300&family=Ubuntu:wght@300&display=swap');
.nicefont{
